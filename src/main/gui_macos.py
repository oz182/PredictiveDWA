...
class MacOSSimulationGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Predictive DWA Simulation (macOS)")
...
'''
            ...
            script_path = "temp_simulation_macos.py"
    ...
    def on_closing(self):
        ...
        try:
            if os.path.exists("temp_simulation_macos.py"):
                os.remove("temp_simulation_macos.py")
        except:
            pass
